...
function createWebApp(options = {}) {
  ...
  app.use((error, _req, res, _next) => {
    const conflictCode = error.code === 'CONFIG_DRIFT' || error.code === 'RESTORE_FORCE_REQUIRED';
    const statusCode = Number(error.statusCode || error.status) || (conflictCode ? 409 : 500);
