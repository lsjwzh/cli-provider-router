...
const durableStore = require('./durable-store');
...
module.exports = {
  ...
  readJsonStrict: atomicJson.readJsonStrict,
  removeFile: atomicJson.removeFile,
  writeJsonAtomic: atomicJson.writeJsonAtomic,
  backupFilePath: atomicJson.backupFilePath,
  rotateJsonBackups: atomicJson.rotateJsonBackups,
  loadOrRecover: atomicJson.loadOrRecover,
  CorruptedStateError: atomicJson.CorruptedStateError,

  DEFAULT_LOCK_TIMEOUT_MS: durableStore.DEFAULT_LOCK_TIMEOUT_MS,
  DEFAULT_LOCK_STALE_MS: durableStore.DEFAULT_LOCK_STALE_MS,
  DEFAULT_DURABLE_BACKUPS: durableStore.DEFAULT_DURABLE_BACKUPS,
  RevisionConflictError: durableStore.RevisionConflictError,
  LockTimeoutError: durableStore.LockTimeoutError,
  acquireFileLock: durableStore.acquireFileLock,
  withFileLock: durableStore.withFileLock,
  createDurableStore: durableStore.createDurableStore,
