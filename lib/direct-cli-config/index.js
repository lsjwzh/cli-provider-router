...
function createDirectCliConfigManager(options = {}) {
  ...
  function apply(input = {}) {
    ...
    try {
      ...
      writeJsonAtomic(stateFile(cli), activeState);
      return activeState;
    } catch (error) {
  ...
  function status(input = {}) {
    ...
    return {
      ...publicState,
      active: true,
      recoveryRequired: state.phase === 'applying' || state.phase === 'recovery-required',
      recoverySafe,
      profileDrifted,
      credentialStatus,
