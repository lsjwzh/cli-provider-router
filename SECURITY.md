...
- The local proxy and planned Web console bind to loopback by default. Loopback is not authentication; untrusted local processes may still reach it.
...
- Reversible CC-Switch takeover is a separate, upcoming write feature. It must use a verified backup, transaction, allowlist of fields, and conflict-aware restore. See `docs/ccswitch-safety.md`.
